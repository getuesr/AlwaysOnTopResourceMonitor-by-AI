...
try:
    from PyQt5.QtCore import QTimer, Qt, QRect, QRectF
...
# 配置（固定隐藏文件名）
# --------------------------
CONFIG_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), ".FloatingWindowMonitor_config.json")
DEFAULT_CONFIG = {
    "show_name": True,
    "show_pid": True,
    "show_cpu": True,
...
class ScrollingLabel(QLabel):
    ...
    def paintEvent(self, event):
        ...
        painter.setPen(QColor(255, 255, 255))  # 保底白色，但背景已变白，黑色字更清
        doc = QTextDocument()
